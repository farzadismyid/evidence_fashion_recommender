...
CHAPTERS: dict[int, dict[str, Any]] = {
    ...
    3: {
        ...
        "title": "Methodology",
        "figures": {
            "3.3": ("fig_01_system_architecture.svg", "System architecture and frozen experimental boundary"),
            "3.4.3": ("fig_04_dataset_pipeline.svg", "Deterministic data preparation and leakage-control pipeline"),
            "3.6.2": ("fig_03_evidence_trace.svg", "Exact five-rule evidence trace used in reranking and explanation"),
            "3.9.2": ("fig_02_evidence_ablation.svg", "Paired explanation conditions with common context A and trace B"),
            "3.10": ("fig_09_prompt_ablation.svg", "Validation-only Rule-RAG prompt ablation"),
        },
        "table_captions": [],
    },
    4: {
        ...
        "title": "Results",
        "figures": {
            "4.4": ("fig_05_recommendation_metrics.svg", "Confirmatory recommendation effectiveness at rank ten"),
            "4.6": ("fig_14_stage8_length_and_density.png", "Explanation length and unsupported-attribute density"),
            "4.8": ("fig_10_stage8_primary_metrics.png", "Primary Decision-Trace Alignment and UIAR results"),
            "4.9.3": ("fig_13_stage8_generator_heterogeneity.png", "Generator heterogeneity in DTA and UIAR"),
            "4.12": ("fig_11_stage8_judge_paired_effects.png", "Paired automated explanation-quality effects"),
            "4.13": ("fig_12_stage8_metric_judge_associations.png", "Within-condition association of targeted metrics and quality judgments"),
        },
        "table_captions": [
            "Confirmatory micro recommendation effectiveness with 95% query-outfit-clustered intervals",
            "Paired automated explanation-quality differences with 95% case-clustered intervals",
        ],
    },
    5: {
